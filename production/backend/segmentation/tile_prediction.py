...
import scipy
import torch
from segmentation.wsi_reader import get_reader_impl
...
class TilePrediction(object):
    def __init__(
        ...
        self.mpp_level_0 = mpp_level_0
        self.mask_magnification = mask_magnification
    ...
    def _read_data(self, filename):
        ...
        if self.mpp_level_0:
            print("slides mpp manually set to", self.mpp_level_0)
            mpp = self.mpp_level_0
        else:
            try:
                mpp = slide.mpp[0]
            except Exception:
        ...
        downsample = wsi_highest_magnification / self.mask_magnification
